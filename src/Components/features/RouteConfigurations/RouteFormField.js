...
import FormEditableField from '../FormComponents/FormEditableField';
import { getFieldType } from '../FormComponents/FormUtils';
...
const RouteFormField = ({ routeCode, field, required, values, dataTypes, handleChange, handleBlur, touched, errors, disabled, setSourceTables, codeFields, dropdownFields }) => {
