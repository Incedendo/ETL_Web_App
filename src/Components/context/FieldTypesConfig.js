...
export const TABLES_NON_EDITABLE_COLUMNS = {
    ...
    "CATALOG_ENTITY_LINEAGE": ["CATALOG_ENTITY_LINEAGE_ID", 'CATALOG_ENTITIES_ID', 'DOMAIN', 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE'],
    "CATALOG_ITEMS": ["CATALOG_ITEMS_ID", 'CATALOG_ENTITIES_ID', 'DOMAIN', 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE', 'COLUMN_NAME'],
