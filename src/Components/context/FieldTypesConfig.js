...
export const TABLES_NON_EDITABLE_COLUMNS = {
    ...
    "CATALOG_ENTITIES": ["CATALOG_ENTITIES_ID", 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE'],
    "CATALOG_ENTITY_LINEAGE": ["CATALOG_ENTITY_LINEAGE_ID", 'CATALOG_ENTITIES_ID', 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE'],
    "CATALOG_ITEMS": ["CATALOG_ITEMS_ID", 'CATALOG_ENTITIES_ID', 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE', 'COLUMN_NAME'],
    'DATA_STEWARD_DOMAIN': ['DATA_STEWARD_ID', 'DATA_DOMAIN_ID', 'EMAIL', 'FNAME', 'LNAME', 'DOMAIN', 'DOMAIN_DESCRIPTIONS'],
    'CATALOG_ENTITY_DOMAIN': ['CATALOG_ENTITIES_ID', 'DATA_DOMAIN_ID', 'TARGET_DATABASE', 'TARGET_SCHEMA', 'TARGET_TABLE', 'DOMAIN', 'DOMAIN_DESCRIPTIONS'],
}
